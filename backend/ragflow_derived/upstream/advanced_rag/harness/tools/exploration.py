...
from ragflow_derived.upstream.advanced_rag.harness.structure_qa import _ask_structure
...
async def _kg_search(
    ...
    from ragflow_derived.upstream.doc_store import MatchTextExpr, OrderByExpr
...
async def graph_explore(tools, query: str, keywords: str = "", doc_scope: list[str] | None = None) -> dict:
    ...
    """
    from ragflow_derived.upstream.advanced_rag.harness.tools.search import _narrow_by_keywords
    ...
    from ragflow_derived.upstream.advanced_rag.harness.tools.navigation import _doc_aggs, _load_chunks_by_ids
...
async def wiki_query(tools, query: str, keywords: str = "") -> dict:
    ...
    """
    from ragflow_derived.full_runtime import settings
    from ragflow_derived.upstream.doc_store import FusionExpr, OrderByExpr
    from ragflow_derived.upstream.runtime import thread_pool_exec
