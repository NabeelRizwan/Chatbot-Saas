...
from ragflow_derived.upstream.advanced_rag.harness.chunk_utils import (
    _chunk_id,
    _chunk_text,
    _snippet,
    _xml_escape,
...
async def dataset_navigation_by_tree(tools, topic: str, keywords: str = "", doc_scope: list[str] | None = None) -> list[str]:
    ...
    from ragflow_derived import dataset_catalog as dataset_api_service
...
# name.
from ragflow_derived.upstream.advanced_rag.harness.tools.exploration import (  # noqa: F401
...
from ragflow_derived.full_runtime import RequestTools
_tools_ref = RequestTools()
