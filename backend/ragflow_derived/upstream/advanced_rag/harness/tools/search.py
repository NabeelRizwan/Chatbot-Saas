...
from ragflow_derived.upstream.advanced_rag.harness.chunk_utils import (  # noqa: F401
    _chunk_attr,
    _chunk_id,
    _chunk_text,
    _dataset_id,
...
from ragflow_derived.upstream.advanced_rag.harness.tools.text_processing import (  # noqa: F401
    _compact_keywords,
    _highlight_keywords,
...
async def hybrid_search(
    ...
    try:
        from ragflow_derived.upstream.advanced_rag.harness.memory import add as _memory_add
...
# from this module.
from ragflow_derived.upstream.advanced_rag.harness.tools.compiled_expansion import (  # noqa: F401
...
def _base_chat_mdl(tools_slot):
    ...
    try:
        ...
        if not callable(getattr(mdl, "async_completion", None)):
            _LOG.error(
