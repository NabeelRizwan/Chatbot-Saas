...
from ragflow_derived.full_runtime import has_canceled
from ragflow_derived.full_runtime import TaskCanceledException
from ragflow_derived.full_runtime import timeout
from ragflow_derived.upstream.graphrag.entity_resolution import EntityResolution
from ragflow_derived.upstream.graphrag.checkpoints import (
...
from ragflow_derived.upstream.graphrag.general.extractor import Extractor
from ragflow_derived.upstream.graphrag.general.graph_extractor import GraphExtractor as GeneralKGExt
from ragflow_derived.upstream.graphrag.light.graph_extractor import GraphExtractor as LightKGExt
from ragflow_derived.upstream.graphrag.phase_markers import (
    PHASE_COMMUNITY,
    PHASE_RESOLUTION,
    clear_phase_markers,
    has_phase_marker,
...
from ragflow_derived.upstream.graphrag.utils import (
    GraphChange,
    chunk_id,
    does_graph_contains,
    get_graph,
...
from ragflow_derived.upstream.runtime import native_tokenizer as rag_tokenizer
from ragflow_derived.upstream import search
from ragflow_derived.full_runtime import OwnedCompileLock as RedisDistributedLock
...
def _select_extractor(graphrag_config: dict):
    ...
    if method == "general":
        return GeneralKGExt
    if method == "ner":
        from ragflow_derived.upstream.graphrag.ner.graph_extractor import GraphExtractor as NerKGExt
        return NerKGExt
    return LightKGExt
...
async def extract_community(
    ...
    # Optional native community dependency is loaded only for this mode.
    from ragflow_derived.upstream.graphrag.general.community_reports_extractor import CommunityReportsExtractor
