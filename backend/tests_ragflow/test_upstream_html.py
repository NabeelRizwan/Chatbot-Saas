# Modified for Chatbot-SaaS: namespace/test isolation; see port manifest.
#
...
from ragflow_derived.upstream import html_parser as _html_mod
...
def scoped_tokenizer(monkeypatch):
    monkeypatch.setattr(RAGFlowHtmlParser, "tokenizer", _FakeTokenizer())
...
_UNIFIED_HTML_FIXTURE = Path(__file__).with_name("upstream_html_cases.json")
