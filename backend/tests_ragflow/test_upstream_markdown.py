...
import pytest
from ragflow_derived.upstream import markdown_parser as module

@pytest.fixture
def markdown_element_extractor():
    return module.MarkdownElementExtractor

@pytest.fixture
def markdown_parser_module():
    return module
